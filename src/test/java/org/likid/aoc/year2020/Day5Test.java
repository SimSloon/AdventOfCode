...
class Day5Test {
    ...
    @Test
    void should_find_highest_boarding_pass() throws IOException {
        ...
        assertThat(max).isEqualTo(974);
    }

    @Test
    void should_find_boarding_pass_id() throws IOException {
        List<String> inputs = Util.readFileAsString("classpath:year2020/day5/input");
        ...
        assertThat(mySeatId.get()).isEqualTo(646);
    }
