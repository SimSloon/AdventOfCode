...
class Day3Test {
    ...
    @Test
    void should_count_trees_1() throws IOException {
        ...
        assertThat(nbTrees).isEqualTo(252);
    }

    @Test
    void should_count_trees_2() throws IOException {
        List<String> inputs = Util.readFileAsString("classpath:year2020/day3/input");
        ...
        assertThat(total).isEqualTo(2608962048L);
    }
