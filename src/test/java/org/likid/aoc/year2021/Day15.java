...
public class Day15 {
    ...
    @Test
    public void should_day15_ex1() throws IOException {
        System.out.println("day 15");
        List<String> inputs = Util.readFileAsString("classpath:year2021/day15/input");

        Integer[][] locations = parseLocations(inputs);
        ...
        System.out.println("result ex 1 : " + shortestDistance);
        assertThat(shortestDistance).isEqualTo(769);
    }

    @Test
    public void should_day15_ex2() throws IOException {
        System.out.println("day 15");
        List<String> inputs = Util.readFileAsString("classpath:year2021/day15/input");

        Integer[][] locations = parseAllLocations(inputs);
        Integer shortestDistance = dijkstra(
                new Position(0, 0, 0),
                new Position(locations[0].length - 1, locations.length - 1, Integer.MAX_VALUE),
                locations);

        System.out.println("result ex 2 : " + shortestDistance);
        assertThat(shortestDistance).isEqualTo(2963);
    }
