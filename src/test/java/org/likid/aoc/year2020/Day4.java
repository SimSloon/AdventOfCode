...
public class Day4 {
	...
	@Test
	public void should_valide_password_1() throws IOException {
		countPasswords(false);
	}
	@Test
	public void should_valide_password_2() throws IOException {
		countPasswords(true);
	}

	private void countPasswords(boolean part2) throws IOException {
