...
public class Day2 {
	...
	@Test
	public void should_valide_passwords_1() throws IOException {
		parseAndGetTotalValidPasswords(1);
	}

	@Test
	public void should_valide_passwords_2() throws IOException {
		parseAndGetTotalValidPasswords(2);
	}

	private void parseAndGetTotalValidPasswords(int verificationType) throws IOException {
