...
class Day9Test {
    ...
    void should() throws IOException {
        ...
        assertThat(badNumber).isEqualTo(18272118);

        Pair<Long, Long> pair = findContinuousNumbers(badNumber, inputs);
        long result = pair.getLeft() + pair.getRight();
        System.out.println("Sum of small and large : " + result);
        assertThat(result).isEqualTo(2186361);
    }
